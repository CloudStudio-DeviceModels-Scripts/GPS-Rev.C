...
# Parsing Script – GPS - Rev. C

This **Parsing** script is designed for the **GPS** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – GPS Rev. C

Este script de **Parsing** está diseñado para el modelo **GPS** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
